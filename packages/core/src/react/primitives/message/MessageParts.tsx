...
export const MessagePartComponent: FC<MessagePartComponentProps> = ({
  ...
  if (type === "tool-call") {
    ...
    const respondToApproval = aui.part().respondToApproval;
...
const RegisteredToolUI: FC = () => {
  ...
  return (
    <Render
      ...
      respondToApproval={aui.part().respondToApproval}
    />
  );
};
...
export type EnrichedPartState =
  | (Extract<PartState, { type: "tool-call" }> & {
      ...
      /** Approve or deny a tool call awaiting server-side approval. */
            ...
            get part() {
              ...
              if (state.type === "tool-call") {
                ...
                return {
                  ...
                  respondToApproval: partMethods.respondToApproval,
                };
              }
              if (state.type === "data") {
                const hasUI =
